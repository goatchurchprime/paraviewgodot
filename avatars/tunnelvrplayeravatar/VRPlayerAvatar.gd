...
var handobjectleft = null
var handobjectright = null
...
func _ready():
	...
	handobjectleft = arvrorigin.get_node("XRControllerLeft/LeftHand/Hand_Nails_low_L")
	handobjectright = arvrorigin.get_node("XRControllerRight/RightHand/Hand_Nails_low_R")
	assert (handobjectleft and handobjectright)
...
func PF_processlocalavatarposition(delta):
	...
	$hand_l.transform = arvrorigin.global_transform.inverse()*handobjectleft.global_transform
	skelbonescopy($hand_l/Armature/Skeleton3D, handobjectleft.get_node("Armature/Skeleton3D"))
	$hand_r.transform = arvrorigin.global_transform.inverse()*handobjectright.global_transform
	skelbonescopy($hand_r/Armature/Skeleton3D, handobjectright.get_node("Armature/Skeleton3D"))
	if projectedhands:
